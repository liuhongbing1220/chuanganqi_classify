...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul  4 22:43:40 2019
...
from keras.layers import BatchNormalization, Flatten, Dropout, LSTM, Dense, Activation, TimeDistributed,np, Concatenate
...
def main(data_path, output_path):
    ...
    def lstm_cell(main_input):
        ...
        :return: 子模型
        """
        sub_model = TimeDistributed(Dense(384), input_shape=(128, 3))(main_input)
...
if __name__ == '__main__':
    ...
    output = os.path.join(ROOT_DIR, "data", "UCI_HAR_Dataset_output_LSTM")
